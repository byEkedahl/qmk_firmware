...
[_QWERTY] = LAYOUT_ortho_6x12(
    ...
    KC_DEL    ,  KC_END   ,LCTL_T(KC_HOME), KC_LALT	,LGUI_T(KC_ESC), ___   ,				      ___    ,RGUI_T(KC__MUTE), KC_RALT, KC_PGUP, KC_PGDN, KC_ENT),
...
[_LOWER] = LAYOUT_ortho_6x12(
	...
	KC_LALT	, KC_MRWD		,	KC_MSTP		, KC_MPLY		, KC_MFFD   , ___        ,		   	 ___   	 ,	RGUI_T(KC_NO), KC__VOLUP, KC__VOLDOWN, KC_ENT, KC_NO),

[_RAISE] = LAYOUT_ortho_6x12(
  TO(0)   ,   TO(1)   ,   TO(2)   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,          KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   , KC_NO,
  KC_NO   ,  KC_EXLM  ,   KC_AT   ,  KC_HASH  ,   KC_DLR  ,  KC_PERC  ,          KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   , KC_NO,
  KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,          KC_NO   ,   KC_NO   ,  KC_BSPC  ,   KC_DEL  ,   KC_NO   , KC_NO,
  KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,          KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   , KC_AMPR,
 KC_LCBR  ,   KC_LT   ,   KC_GT   ,  KC_RCBR  ,   KC_NO   ,   KC_NO   ,          KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   , KC_NO,
  KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_NO   ,    ___    ,           ___    ,   KC_NO   ,   KC_NO   ,   KC_NO   ,   KC_ENT  , KC_SPC),
