...
[_QWERTY] = LAYOUT_6x6(
	LT(0,KC_EQL),	LT(1,KC_1), LT(2,KC_2),		KC_3	,		KC_4	,		KC_5,							KC_6, KC_7, KC_8, KC_9, KC_0, KC_EQL,
		...
		DEBUG			,	KC_COMM		,		KC_GRV		,	KC_LEFT	,	KC_RGHT	,	LGUI_T(KC_ESC),		KC_UP, KC_DOWN, KC_QUOT, KC_RBRC, KC_MSTP,
								KC_LALT		,	LCTL_T(KC_HOME),	KC_BSPC	, KC_DEL	, KC_END,				KC_RALT, RGUI_T(KC__MUTE), KC_PGUP, KC_PGDN, KC_ENT, KC_SPC),
